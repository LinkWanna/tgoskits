//! 编码器/解码器命令结构 — 对应 Linux `v4l2_enc_idx`、`v4l2_encoder_cmd`、
//! `v4l2_decoder_cmd`。
//!
//! 这些属于 stateful codec API（`G_ENC_INDEX`、`ENCODER_CMD`、
//! `DECODER_CMD` 及 TRY 变体）。新型 stateless codec 设备不再实现，
//! 归入遗留接口。
