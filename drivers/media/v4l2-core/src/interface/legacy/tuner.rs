//! 调谐器（Tuner）与频率相关结构 — 对应 Linux `struct v4l2_tuner` 等。
//!
//! Tuner/Radio 族接口（G/S_TUNER、G/S_FREQUENCY、ENUM_FREQ_BANDS、
//! S_HW_FREQ_SEEK）属于模拟电视/收音机时代；现代视频采集设备
//! （UVC、HDMI）不再实现。
...
/// 调谐器类型 — 对应 Linux `enum v4l2_tuner_type`。
#[repr(u32)]
