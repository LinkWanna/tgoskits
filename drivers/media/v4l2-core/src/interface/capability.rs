...
bitflags! {
    ...
    pub struct Capabilities: u32 {
        ...
        /// 是切片 VBI（sliced VBI）采集设备。
        const SLICED_VBI_CAPTURE = 0x0000_0040;
        /// 是切片 VBI（sliced VBI）输出设备。
        ...
        /// I/O 由媒体控制器（media controller）控制。
