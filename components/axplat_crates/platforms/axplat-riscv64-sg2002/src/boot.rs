...
unsafe fn init_boot_page_table() {
    ...
    // 《玄铁 C906 用户手册》 5.2.2.1 页表结构
    const DEVICE_FLAGS: u64 = 0b10011 << 59 | PTE_FLAGS;
    const KERNEL_FLAGS: u64 = 0b01111 << 59 | PTE_FLAGS;

    // 《SG2002 技术参考手册》 3.3 地址空间映射
    unsafe {
        // 0x0000_0000..0x4000_0000, VRWX_GAD, 1G block
        BOOT_PT_SV39[0] = (0x0 << 10) | DEVICE_FLAGS;
        BOOT_PT_SV39[1] = (0x40000 << 10) | DEVICE_FLAGS;
        // 0x8000_0000..0xc000_0000, VRWX_GAD, 1G block
        BOOT_PT_SV39[2] = (0x80000 << 10) | KERNEL_FLAGS;
        // 0xffff_ffc0_0000_0000..0xffff_ffc0_4000_0000, VRWX_GAD, 1G block
        BOOT_PT_SV39[0x100] = (0x0 << 10) | DEVICE_FLAGS;
        BOOT_PT_SV39[0x101] = (0x40000 << 10) | DEVICE_FLAGS;
